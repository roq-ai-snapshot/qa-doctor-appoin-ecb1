...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'healthcare_provider.update': {
    ...
    tenantPath: ['organization', 'healthcare_provider'],
    userPath: [],
  },
  'appointment.create': {
    roles: ['healthcare-provider', 'medical-staff'],
    key: 'new-appointment-booked',
    tenantPath: ['organization', 'healthcare_provider', 'appointment'],
    userPath: [],
  },
  'insurance_provider.update': {
    roles: ['system-administrator'],
    key: 'insurance-plan-update',
    tenantPath: ['organization', 'insurance_provider'],
    userPath: [],
  },
};
